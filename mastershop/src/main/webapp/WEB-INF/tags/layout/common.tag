...
<body background="/resources/images/shopmaster/shopmaster_bg2.gif">
	<div id="wrap">
		...
		<div id="main_bottom">
			...
			<div class="mbottom_line2"></div>			
			<div style="color:#666666;" class="mbottom1">
				<div style="float:left; width:50px; height:36px;"><img src="/resources/images/shopmaster/bottom_logo.gif" border="0"/></div>
			...
			<div style="color:#777777;" class="mbottom2">
