...
<layout:common>
    ...
    <jsp:attribute name="javascript">
    	...
    	<script langauge="javascript">
    		var fd_menu_yn = '${cmsSubMenu.fd_menu_yn}';
    		$(document).ready
    		(
    			function()
    			{   	
    ...
    <jsp:body>    
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="BORDER: #dcdcdc 1px solid; padding:0 0 0 0">
			...
			<tr height="25">
				...
				<td class="item_title_border">메인메뉴로 가기</td>			
			</tr>    
			<tr height="1"><td colspan="7" bgcolor="#dfdfdf"></td></tr>
			<tr height="25">
				<td class="item_title_border">메인메뉴</td>
				<td class="item_input_border" align="center">${cmsMainMenu.fd_sort_no }</td>
				<td class="item_input_border" align="center">${cmsMainMenu.pk_url_code }</td>
				<td class="item_input_border" align="center">${cmsMainMenu.fd_name }</td>
				<td class="item_input_border">${cmsMainMenu.fd_url }</td>
				<td class="item_input_border" align="center">
					<c:if test="${cmsMainMenu.fd_menu_yn == 'Y' }">사용</c:if>
					<c:if test="${cmsMainMenu.fd_menu_yn == 'N' }">미사용</c:if>
				</td>
				<td class="item_input_border" align="center"><a href="/manager/mainMenu.do">Click</a></td>
			</tr>  
		</table>			
    	<br/>
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="BORDER: #dcdcdc 1px solid; padding:0 0 0 0">
			...
			<input type="hidden" name="org_pk_url_code" value="${cmsSubMenu.pk_url_code }" /> 
			<input type="hidden" name="fd_group_code" value="${cmsMainMenu.pk_url_code }" />								
			<tr height="0">
				<td width="15%"></td>
				<td width="35%"></td>
				<td width="15%"></td>
			...
			<tr height="30">
				<td class="item_title_border">코드</td>
				<td class="item_input">
					<input type="text" id="pk_url_code" name="pk_url_code" maxlength="4" minbytes="4" msg="코드는 4자여야 합니다." class="numOnly" value="${cmsSubMenu.pk_url_code }">							
				</td>				
				<td class="item_title_border">이름</td>
				<td class="item_input">
					<input type="text" id="fd_name" name="fd_name" style="width:200px" minbytes="2" msg="이름은 2자이상 입력하셔야 합니다." value="${cmsSubMenu.fd_name}">								
				</td>					
			</tr>
			...
			<tr height="30">
				<td class="item_title_border">경로</td>
				<td class="item_input">
					<input type="text" id="fd_url" name="fd_url" style="width:400px" value="${cmsSubMenu.fd_url}">							
				</td>				
				<td class="item_title_border">사용여부</td>
				<td class="item_input"> 
			...
			<tr height="30">
				...
				<td class="item_input" colspan="3">
					<input type="text" id="fd_sort_no" name="fd_sort_no" minbytes="1" msg="순서를 입력하셔야 합니다." class="numOnly" style="width:50px" value="${cmsSubMenu.fd_sort_no}">							
				</td>						
			</tr>	
			</form>															
		</table>	
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="BORDER: #dcdcdc 1px solid; padding:0 0 0 0">
			...
			<!-- DYNAMIC AREA 'list' -->
			<c:if test="${!empty subMList}">
				<c:forEach var="item" items="${subMList}" varStatus="status" >
				<tr height="1"><td colspan="7" bgcolor="#dfdfdf"></td></tr>
			...
			<c:if test="${empty subMList}">
				...
				<tr height="60" bgcolor="white"> 	
					<td class="item_input" align="center" colspan="8">&nbsp;등록된 하위메뉴가 없습니다</td>
				</tr>
			</c:if>				
		</table>           
    </jsp:body>
